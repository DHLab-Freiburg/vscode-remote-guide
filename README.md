...
- Enter `ssh $u@gpu-server.dhlab.intra.uni-freiburg.de "mkdir ~/.ssh"`
- Enter `type $env:USERPROFILE\.ssh\id_ed25519.pub | ssh $u@gpu-server.dhlab.intra.uni-freiburg.de "mkdir -p ~/.ssh; cat >> ~/.ssh/authorized_keys"`
